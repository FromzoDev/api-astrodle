...
import { DashboardStatsService, GameOverviewEntry } from './dashboard-stats.service';
...
export class DashboardController {
  ...
  @Auth(Role.Admin)
  @Get('games-overview')
  async getGamesOverview(@Query('mode') mode: GameMode): Promise<ApiResponse<GameOverviewEntry[]>> {
