...
export class GuessSkyObjectStatsRepository {
 ...
 async incrementOnFinish(mode: GameMode, attemptsUsed: number, won: boolean): Promise<void> {
  ...
  const totalAttemptsSum = stats.avgAttemptsUsed * stats.totalPlayed + attemptsUsed;
