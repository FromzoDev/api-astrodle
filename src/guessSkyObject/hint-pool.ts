...
export const HINT_POOL: HintDefinition[] = [
  ...
  {
    key: 'discoverer.dateOfBirth',
    resolve: (o) => o.discoverer?.dateOfBirth?.toISOString().split('T')[0] ?? null,
  },
  {
    key: 'discoverer.dateOfDeath',
    resolve: (o) => o.discoverer?.dateOfDeath?.toISOString().split('T')[0] ?? null,
  },
  {
    key: 'discoverer.description',
    resolve: (o) => o.discoverer?.description ?? null,
  },
