...
export class TelescopeQueryDto extends FilterDto {
  ...
  @ApiProperty({
    required: false,
    enum: TelescopeSpectrum,
    description: 'Filtrer par spectre',
  })
  @IsOptional()
  ...
  @ApiProperty({
    required: false,
    description:
      'Filtrer les télescopes amateurs (true) ou professionnels (false)',
  })
  @IsOptional()
  @Transform(({ value }) => {
  ...
  @ApiProperty({
    required: false,
    description: "Filtrer par ID d'organisation associée",
  })
  @IsOptional()
  @Type(() => Number)
  @IsInt()
